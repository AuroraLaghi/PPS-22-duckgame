...
object AlertUtils:
  ...
  /** Displays a victory dialog for the winner of the game.
    ...
    * @return
    *   An Optional[ButtonType] value representing the button clicked by the user in the dialog:
  ...
  /** Displays a warning dialog informing the user that there are not enough players to start the game.
    *
    * @return
    *   An Optional[ButtonType] value representing the button clicked by the user in the dialog:
    *   - Some(ButtonType.OK) if the user clicked the "OK" button.
  ...
  /** Displays a warning dialog informing the user that a player's name is empty.
    *
    * @return
    *   An Optional[ButtonType] value representing the button clicked by the user in the dialog:
    *   - Some(ButtonType.OK) if the user clicked the "OK" button.
  ...
  /** Displays a warning dialog informing the user that both players are stuck in the well or prison and that they need
    * to return to the main menu.
    *
    * @return
    *   An Optional[ButtonType] value representing the button clicked by the user in the dialog: * Some(ButtonType.OK)
    *   if the user clicked the "OK" button. * None if the dialog was closed without the user clicking any button.
    */
