...
import it.unibo.pps.duckgame.utils.PrologGameUtils.CellInGridTerm.given
import it.unibo.pps.duckgame.utils.PrologGameUtils.PrologSolution.given

/** Returns pair of (Int, Int) for two different methods in [[it.unibo.pps.duckgame.utils.GameUtils]]
...
object PrologGameUtils:
  ...
  object PrologEngine:
    ...
    case class PrologEngine(theory: Theory) extends Engine :
      ...
      override def solve: Term => SolveInfo = term =>
        engine solve term
